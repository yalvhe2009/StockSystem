...
namespace StockSystem.Migrations
{
    ...
    [Migration("20190710011158_modifyInStockSummary")]
    partial class modifyInStockSummary
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StockSystem.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("StockSystem.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("StockSystem.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("StockSystem.StockSystem.Customers.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("SS_Customer");
                });

            modelBuilder.Entity("StockSystem.StockSystem.Goods.Goods", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<string>("GoodsManufacturer")
                        .IsRequired()
                        .HasMaxLength(80);
                    ...
                    b.Property<DateTime>("GoodsProuductionDate");
            ...
            modelBuilder.Entity("StockSystem.StockSystem.InStocks.InStockSummary", b =>
                {
                    ...
                    b.Property<string>("InStockNumber")
                        .IsRequired();
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("StockSystem.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("StockSystem.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("StockSystem.Authorization.Roles.Role", b =>
                {
                    b.HasOne("StockSystem.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("StockSystem.Authorization.Users.User", "DeleterUser")
                        .WithMany()
