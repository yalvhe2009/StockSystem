...
using StockSystem.Sessions;
using StockSystem.Web.Models.Account;
using StockSystem.Web.Views.Shared.Components.TenantChange;

namespace StockSystem.Web.Controllers
{
    public class AccountController : StockSystemControllerBase
    {
