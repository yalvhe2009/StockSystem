...
namespace StockSystem.Tests.Stockings
{
    public class StockingAppServic_Tests : StockSystemTestBase
    {
        ...
        [Fact]
        public async System.Threading.Tasks.Task CreateOrUpdateStocking_Test()
        {
            ...
            // Act
            await _stockingAppService.CreateOrUpdateStockingAsync(new CreateOrUpdateStockingInput { StockingEditDto=dto});
